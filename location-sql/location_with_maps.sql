...
create schema project_2_location_service_maps;
set schema 'project_2_location_service_maps';
...
insert into project_2_location_service_maps.users ("username", "password", "first_name", "last_name", "affiliation", "address", "email", "role", "image")
...
insert into locations("name", "realm", "governance", "primary_population", "description", "lat", "lng")
	values ('The Lonely Mountain', 'Erebor', 'Heirs of Durin', 'Dwarves', 'A mountain in the north-east of Rhovanion and the source of the river Running, and a major Dwarven stronghold', -39.304394, 175.526879),
           ...
           ('Caras Galadon', 'Lorien', 'The Kings of Lorien', 'Elves', 'Also known as the "Heart of Elvendom on Earth," this golden wood is protected by the power of Galadriel', -45.092183, 168.538091),
