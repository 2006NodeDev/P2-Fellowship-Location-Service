...
var mockResponse = function () {
    var res = {}; //the res object needs status and send
...
describe('userUpdateLocationService', function () { return __awaiter(void 0, void 0, void 0, function () {
    var locationId, userId, locationVisited, locationRating, locationImage, req, res, next;
    return __generator(this, function (_a) {
        ...
        it('Should not allow update because location not found', function () {
            //set variables to pass in?
            location_service_1.userUpdateLocationService(locationId, userId, locationVisited, locationRating, locationImage);
            expect(res.status).toBeCalledWith(404);
            expect(res.send).toBeCalledWith('That location does not exist');
            expect(next).not.toBeCalled;
        });
        //this seems like more of a dao test...
        it('Should not allow update if location was not visited', function () {
            req.location = {
                "visited": false,
                "rating": 0,
                "image": ""
...
//# sourceMappingURL=user-update-location-service.test.js.map